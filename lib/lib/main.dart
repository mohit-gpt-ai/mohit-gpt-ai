...
class HomeScreen extends StatelessWidget {
  ...
  const HomeScreen({super.key, required this.onAskAI});
...
class _AIChatScreenState extends State<AIChatScreen> {
  ...
  Future<void> send() async {
    ...
    final result = await ai.ask(
      question.isEmpty ? 'Question from uploaded photo' : question,
    );
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text('Question photo selected'),
                ),
                IconButton(
...
class BatchesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const batches = [
      ('NEET 2027 Complete Batch', 'Physics, Chemistry, Biology'),
      ('Physics Foundation', 'Concept videos and practice'),
      ('Biology Mastery', 'NCERT and tests'),
    ];
